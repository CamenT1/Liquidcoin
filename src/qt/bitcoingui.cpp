...
{
    resize(850, 550);
    setWindowTitle(tr("Liquidcoin Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Liquidcoin address"));
    ...
    aboutAction->setToolTip(tr("Show information about Liquidcoin"));
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Liquidcoin"));
    openBitcoinAction = new QAction(QIcon(":/icons/bitcoin"), tr("Open &Liquidcoin"), this);
    openBitcoinAction->setToolTip(tr("Show the Liquidcoin window"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip("Liquidcoin client");
    trayIcon->setIcon(QIcon(":/icons/toolbar"));
    connect(trayIcon, SIGNAL(activated(QSystemTrayIcon::ActivationReason)),
            this, SLOT(trayIconActivated(QSystemTrayIcon::ActivationReason)));
    trayIcon->show();

    notificator = new Notificator(tr("liquidcoin-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "open liquidcoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Liquidcoin network", "", count));
}
