...
uint256 hashGenesisBlock("0xdfa93ad7809e452f6508a48e0b375a54e458c7d6ed6aa7c46bd636c2daadf942");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20);
const int nTotalBlocksEstimate = 5000; // Conservative estimate of total nr of blocks on main chain
...
{
    int64 nSubsidy = 25* COIN;//Liquidcoin: the amazing mythogenic premine happens here //Not today.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast)
{
    const int64 nTargetTimespan = 7 * 24 * 60 * 60; // liquidcoin: 3.5 days for diff retarget
    const int64 nTargetSpacing = 5 * 60; // liquidcoin: 5 minutes between blocks
    ...
    // liquidcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < (uint64)15000000 + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        ThreadSafeMessageBox(strMessage, "liquidcoin", wxOK | wxICON_EXCLAMATION);
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        // bnProofOfWorkLimit = CBigNum(~uint256(0) >> 28); // liquidcoin: starting difficulty is the same for testnet
        // liquidcoin: increase each by adding 2 to bitcoin's value.
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=4e77ffdc1b, nTime=1315469777, nBits=0x1e0ffff0, nNonce=613795, vtx=1)
        //   CTransaction(hash=4e77ffdc1b, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //     CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104404e592054696d65732030352f4f63742f32303131205374657665204a6f62732c204170706c65e280997320566973696f6e6172792c2044696573206174203536)
        //     CTxOut(nValue=50.00000000, scriptPubKey=04678afdb0fe5548271967f1a67130)
        //   vMerkleTree: 4e77ffdc1b

        // Genesis block
        const char* pszTimestamp = "Dubstep's early roots are in the more experimental releases of UK garage producers";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x9097b27d449888390e5066a365a1bad11b00f5d14d16c14bb57f1161f9cde19d"));
